...
int main()
{
    ...
    std::weak_ptr<Actor> camActor2 = gameEngine->GetWorld().lock()->SpawnActor();
    CameraComponent* camComp = camActor2.lock()->AddComponent<CameraComponent>();
    camComp->SetRenderTarget(window2);
    camActor2.lock()->GetTransform().SetWorldPosition(glm::vec3(6.0f, 2.0f, 0.0f));
    camActor2.lock()->GetTransform().Rotate(glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    ...
    actor1.lock()->GetTransform().SetLocalScale(glm::vec3(20.0f, 20.0f, 20.0f));
    ...
    actor2.lock()->GetTransform().SetLocalScale(glm::vec3(20.0f, 20.0f, 20.0f));
