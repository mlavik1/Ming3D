#ifndef MING3D_DEBUG_H
#define MING3D_DEBUG_H
...
#define LOG(level) \
	Ming3D::Debug(level, __FILE__,__LINE__)
#define LOG_INFO() \
	Ming3D::Debug(DEBUG_MODE_INFO, __FILE__,__LINE__)
#define LOG_WARNING() \
	Ming3D::Debug(DEBUG_MODE_WARNING, __FILE__,__LINE__)
#define LOG_ERROR() \
	Ming3D::Debug(DEBUG_MODE_ERROR, __FILE__,__LINE__)
#define LOG_EXCEPTION() \
	Ming3D::Debug(DEBUG_MODE_EXCEPTION, __FILE__,__LINE__)
