...
namespace Ming3D
{
    ...
    Actor* ModelLoader::CreateNode(aiNode* aiNode, const std::vector<std::shared_ptr<Mesh>>& meshes, const std::vector<std::shared_ptr<Material>>& materials, const aiScene* scene, Actor* parent)
    {
